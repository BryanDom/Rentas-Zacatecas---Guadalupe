...
def step_impl(context, nombre):  # noqa: F811
...
def step_impl(context, edad):  # noqa: F811
    edad_cap = context.driver.find_element(
        By.CSS_SELECTOR, "p.description:nth-child(3)").text
    assert edad in edad_cap


@then(u'puede ver su sexo "{sexo}"')
def step_impl(context, sexo):  # noqa: F811
    sexo_cap = context.driver.find_element(
        By.CSS_SELECTOR, "p.description:nth-child(4)").text
    assert sexo in sexo_cap


@then(u'puede ver su universidad actual "{universidad}"')
def step_impl(context, universidad):  # noqa: F811
    universidad_cap = context.driver.find_element(
        By.CSS_SELECTOR, "p.description:nth-child(5)").text
    assert universidad in universidad_cap


@then(u'puede ver su teléfono "{num}"')
def step_impl(context, num):  # noqa: F811
    num_cap = context.driver.find_element(
        By.CSS_SELECTOR, "p.description:nth-child(6)").text
...
def step_impl(context, preferencias):  # noqa: F811
    preferencias_cap = context.driver.find_element(
        By.CSS_SELECTOR, "p.description:nth-child(7)").text
...
def step_impl(context, pasatiempos):  # noqa: F811
    pasatiempos_cap = context.driver.find_element(
        By.CSS_SELECTOR, "p.description:nth-child(8)").text
