...
def step_impl(context):  # noqa: F811
    ...
    # porque en 2, bueno el 0 que es par guardo el tipo de casa
    # y el impar este caso el 1
    # guardo el precio y asi sucesivamente con cada propiedad que pasa.
    # Lo vamos guardando
    # en una lista
...
def step_impl(context):  # noqa: F811
    (context.driver.find_element(
        By.XPATH,
        "/html/body/div/div[2]/div/div[3]/div/div/div[2]/div[2]/a")
        .click())
...
def step_impl(context):  # noqa: F811
    (context.driver.find_element(
        By.XPATH,
        "/html/body/div/div[2]/div/div/div[3]/div/div[2]/div[1]/a")
        .click())
...
def step_impl(context):  # noqa: F811
    context.driver.find_element(
        By.XPATH, "/html/body/div/div[2]/div/div/div/div[2]/div/p[1]/strong")
...
def step_impl(context):  # noqa: F811
    (context.driver.find_element(
        By.XPATH,
        "/html/body/div/div[2]/div/div/div[3]/div/div[3]/div[1]/a")
        .click())
...
def step_impl(context):  # noqa: F811
    context.driver.find_element(
        By.XPATH, "/html/body/div/div[1]/div[1]/ul/li[3]/a/p").click()
...
def step_impl(context):  # noqa: F811
    (context.driver.find_element(
        By.XPATH,
        "/html/body/div/div[2]/div/div[2]/div[1]/div/div[2]/div[1]/h5"))


@when(u'presiona el botón de inscribirme a la lista de interesados')
def step_impl(context):  # noqa: F811
    context.driver.find_element(
        By.XPATH, "/html/body/div/div[2]/div/div/div[3]/div/div[3]/a").click()


@then(u'puede ver el mensaje de que ya esta inscrito a la lista.')
def step_impl(context):  # noqa: F811
    context.driver.find_element(
        By.XPATH, "/html/body/div/div[2]/div/div/div[1]")
...
def step_impl(context):  # noqa: F811
    context.driver.find_element(
        By.XPATH, "//*[@id=\"form\"]/div[2]/div[2]/a[1]").click()
...
def step_impl(context):  # noqa: F811
    (context.driver.find_element(
        By.XPATH,
        "/html/body/div/div[2]/div/div/div[3]/div/div[3]/div/a")
        .click())
...
def step_impl(context):  # noqa: F811
    context.driver.find_element(
        By.XPATH, "/html/body/div/div[2]/div/div[1]/h1/strong")
