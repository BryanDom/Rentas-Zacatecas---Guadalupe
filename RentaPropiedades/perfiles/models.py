...
class Estudiante (models.Model):
    ...
    foto_perfil = models.ImageField('Foto', upload_to = 'perfiles',null=True, blank=True)
...
class Arrendador (models.Model):
    ...
    edad = models.IntegerField()
    sexo = models.CharField(max_length=1 ,choices=[('M','Masculino'), ('F','Femenino'), ('O','Otro')])
    foto_perfil = models.ImageField('perfil', upload_to = 'perfiles',null=True, blank=True)
